...
namespace MvcMusicStore.Models
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MusicStoreEntities>
    {
        protected override void Seed(MusicStoreEntities context)
        {
            ...
            {
                new Artist { Name = "交响乐团" },
                new Artist { Name = "亚伦·戈德堡" },
                new Artist { Name = "艾斯德" },
                new Artist { Name = "接受" },
                new Artist { Name = "艾德里安·利柏 & 朵琳·德·菲斯" },
                new Artist { Name = "史密斯飞船" },
                new Artist { Name = "艾莎二人组" },
                new Artist { Name = "艾拉妮丝·莫莉塞特" },
                new Artist { Name = "土耳其的阿尔布雷希特 & 新斯科拉·格里高利亚" },
                new Artist { Name = "爱丽丝囚徒乐队" },
                new Artist { Name = "艾米·怀恩豪斯" },
                new Artist { Name = "安妮塔·沃德" },
                new Artist { Name = "安东尼奥·卡洛斯·若宾" },
                new Artist { Name = "金属启示录" },
                new Artist { Name = "声音奴隶" },
                new Artist { Name = "巴里·华兹华斯和BBC音乐会管弦乐队" },
                new Artist { Name = "柏林交响乐团人员汉斯·罗丝波德" },
                new Artist { Name = "柏林乐团的赫尔伯特" },
                new Artist { Name = "比利·考伯汉姆" },
                new Artist { Name = "烈酒公社乐团" },
                new Artist { Name = "黑色安息日乐队" },
                new Artist { Name = "波士顿交响乐团和小泽征尔" },
                new Artist { Name = "英国的交响曲，Ivor和莱斯利·盖瑞特" },
                new Artist { Name = "布鲁斯·迪金森" },
                new Artist { Name = "巴迪·盖伊" },
                new Artist { Name = "卡耶塔诺·费洛索" },
                new Artist { Name = "蛋糕" },
                new Artist { Name = "加利西哥" },
                new Artist { Name = "桂皮埃勒" },
                new Artist { Name = "别致" },
                new Artist { Name = "芝加哥交响乐团和弗里茨赖纳" },
                new Artist { Name = "奇哥布亚奇" },
                new Artist { Name = "表演者" },
                new Artist { Name = "威斯敏斯特教堂唱诗班&西蒙·普雷斯顿" },
                new Artist { Name = "克里斯·康奈尔" },
                new Artist { Name = "克里斯多夫 奥赖利" },
                new Artist { Name = "城市黑" },
                new Artist { Name = "克劳迪奥·Zoli" },
                new Artist { Name = "例的复兴" },
                new Artist { Name = "大卫科弗代尔" },
                new Artist { Name = "深紫色金属" },
                new Artist { Name = "丹尼斯·钱伯斯" },
                new Artist { Name = "爪哇人" },
                new Artist { Name = "唐娜·桑默" },
                new Artist { Name = "恐惧飞艇" },
                new Artist { Name = "埃德·莫塔" },
                new Artist { Name = "旧金山交响乐团" },
                new Artist { Name = "伊莉丝·里加纳" },
                new Artist { Name = "英语音乐会&特雷弗·平诺克" },
                new Artist { Name = "埃里克·克拉普顿" },
                new Artist { Name = "尤金·奥曼迪" },
                new Artist { Name = "信仰破灭（美国一乐队名称）" },
                new Artist { Name = "Falamansa" },
                new Artist { Name = "喷火战机" },
                new Artist { Name = "佐帕军阶和皮弗哈特上尉" },
                new Artist { Name = "回纹装饰" },
                new Artist { Name = "放克Como Le Gusta" },
                new Artist { Name = "杰拉尔德·摩尔" },
                new Artist { Name = "Gilbento吉尔" },
                new Artist { Name = "追溯" },
                new Artist { Name = "贡扎吉尼亚" },
                new Artist { Name = "歌特伯的共生基金代表" },
                new Artist { Name = "枪炮玫瑰（国际著名摇滚乐队）" },
                new Artist { Name = "古斯塔夫•马勒" },
                new Artist { Name = "隐身" },
                new Artist { Name = "铁娘子" },
                new Artist { Name = "詹姆斯·莱文" },
                new Artist { Name = "蝎子乐队" },
                new Artist { Name = "吉米·亨德里克斯" },
                new Artist { Name = "乔Satriani" },
                new Artist { Name = "乔治本" },
                new Artist { Name = "霍塔舞追求" },
                new Artist { Name = "霍塔舞" },
                new Artist { Name = "朱利安鲷" },
                new Artist { Name = "来自里昂的肯特·长野和管弦乐队" },
                new Artist { Name = "齐柏林飞艇" },
                new Artist { Name = "齐柏林飞船" },
                new Artist { Name = "Legiao乌尔班纳" },
                new Artist { Name = "莱尼Kravitz" },
                new Artist { Name = "繁盛艺术古乐团" },
                new Artist { Name = "伦敦交响乐团和查尔斯·麦克拉斯爵士" },
                new Artist { Name = "她曾Souza /罗梅罗Lubambo" },
                new Artist { Name = "露露桑托斯" },
                new Artist { Name = "马科斯山谷" },
                new Artist { Name = "马利里安" },
                new Artist { Name = "玛丽莎蒙特" },
